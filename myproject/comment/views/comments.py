...
class CreateComment(CanCreateMixin, CommentCreateMixin):
    ...
    def form_valid(self, form):
        ...
        #     email = EmailMessage(
        #            " دیدگاه جدید",
        #            "دیدگاه جدیدی برای مقاله ی «{}» که شما نویسنده آن هستید ارسال شده :\n{}{}".format(article , current_site , reverse('prj:detail' , kwargs={'slug' : article.slug })), 
        #             to=[author_email]
        #     )
        #     email.send()
        ...
        #     email = EmailMessage(
        #            "دیدگاه دریافت شد",
        #            "دیدگاه شما دریافت شده و به زودی به آن پاسخ داده میشود",
        #             to=[user_email]
        #     )
        #     email.send()
